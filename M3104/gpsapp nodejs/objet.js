var GPSDistance = function () {};

GPSDistance.prototype.convertToRad = function (degrees) {
    return degrees * (Math.PI / 180);
};

GPSDistance.prototype.distance = function (lat1, long1, lat2, long2) {
    let REarth =  6378.137;
...
GPSDistance.prototype.journeyDistance = function (coordinates) {
    let d = 0;
